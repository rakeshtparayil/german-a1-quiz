...
if active_tab == "🖊️ Deutsch → Englisch":
    ...
    # Topic selector (uses PDF chapter names, independent of main sidebar filter)
    tp_chapter = st.selectbox(
        "Thema wählen",
        PDF_CHAPTER_NAMES,
        key="tp_chapter_select",
    )
    ...
    # Reference list
    st.divider()
    with st.expander("📖 Alle Sätze dieses Themas anzeigen", expanded=False):
